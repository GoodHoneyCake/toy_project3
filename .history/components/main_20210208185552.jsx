...
const STORAGE_KEY = "@save_todosssssssss";
...
const Main = () => {
  ...
  const addTodo = (text) => {
    ...
    saveData({ id: Math.random().toString(), textValue: text, checked: false });
  };
  ...
  const getData = async () => {
    try {
      ...
      jsonValue != null ? setTodos({ todos: JSON.parse(jsonValue) }) : null;
